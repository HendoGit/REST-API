    ...
    if(firstName && lastName && phone && password && tosAgreement){
        ...
        _data.read('users', phone, function(err, data){
            if(err){
                ...
                if(hashedPassword){var userObject = {
                    'firstName' : firstName,
                    'lastName'  : lastName,
                    'phone'     : phone,
...
// @TODO Only let an authenticated user delete their object. Don't them them delete anyone elses
        ...
        _data.read('users', phone, function(err, userData){
            if(!err && userData){
                ...
                if(hashedPassword == userData.hashedPassword){
                    // If valid, create a new token with a random name. Set experation date 1 hour in the future
